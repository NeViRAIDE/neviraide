...
local function setup()
  wk_register({
    ...
    ['<leader>'] = {
      ...
      b = require('config.plugins.which-key.keybindings.main.buffers'),
      c = require('config.plugins.which-key.keybindings.main.color_picker'),
      d = require('config.plugins.which-key.keybindings.main.diagnostic'),
      g = require('config.plugins.which-key.keybindings.main.golang'),
      G = require('config.plugins.which-key.keybindings.main.git'),
      l = require('config.plugins.which-key.keybindings.main.lsp'),
      n = require('config.plugins.which-key.keybindings.main.todo_comments'),
      N = require('config.plugins.which-key.keybindings.main.neogen'),
      t = require('config.plugins.which-key.keybindings.main.telescope'),
      w = require('config.plugins.which-key.keybindings.main.windows'),
    },
  }, { mode = 'n' })
  wk_register({
    ['<leader>'] = {
