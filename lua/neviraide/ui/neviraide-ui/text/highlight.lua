...
local ffi = require('neviraide.ui.neviraide-ui.utils.ffi')
...
function M.get_hl_group(attr_id)
  if attr_id == 0 then return 'Normal' end
  M.queue[attr_id] = attr_id
  return 'NeviraideUIAttr' .. tostring(attr_id)
end
