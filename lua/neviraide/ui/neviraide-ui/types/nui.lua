...
---@alias NeviraideUINuiOptions NuiSplitOptions|NuiPopupOptions|{type: "split"|"popup"}
---@alias _.NeviraideUINuiOptions _.NuiSplitOptions|_.NuiPopupOptions|{type: "split"|"popup"}
