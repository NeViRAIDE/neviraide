...
function M.setup()
  if Config.options.popupmenu.backend == 'cmp' then
    M.backend = require('neviraide.ui.neviraide-ui.ui.popupmenu.cmp')
  elseif Config.options.popupmenu.backend == 'nui' then
    M.backend = require('neviraide.ui.neviraide-ui.ui.popupmenu.nui')
  end
  M.backend.setup()
end
...
function M.on_hide()
  if M.state.visible then
    ...
    vim.schedule(function()
      if not M.state.visible then M.backend.on_hide() end
    end)
  end
end
