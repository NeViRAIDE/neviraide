...
---@overload fun(opts?:ScrollbarOptions):NeviraideUIScrollbar
...
local defaults = {
  ...
  autohide = true,
  hl_group = {
    bar = 'NeviraideUIScrollbar',
    thumb = 'NeviraideUIScrollbarThumb',
  },
...
function Scrollbar:update()
  if not vim.api.nvim_win_is_valid(self.winnr) then return self:hide() end
