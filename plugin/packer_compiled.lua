...
_G.packer_plugins = {
  ...
  ["copilot-cmp"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/ra/.local/share/nvim/site/pack/packer/opt/copilot-cmp",
  ...
  ["copilot.lua"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/ra/.local/share/nvim/site/pack/packer/opt/copilot.lua",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "copilot-cmp", "cmp-buffer", "cmp-calc", "cmp-cmdline", "cmp-path" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
