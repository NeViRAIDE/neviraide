...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-calc", "cmp-path", "cmp-nvim-lua" },
  ...
  ["nvim-cursorline"] = {
    loaded = true,
    path = "/home/ra/.local/share/nvim/site/pack/packer/start/nvim-cursorline",
  ...
  ["startup.nvim"] = {
    config = { "\27LJ\2\nW\0\0\5\0\4\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0006\2\0\0'\4\3\0B\2\2\0A\0\0\1K\0\1\0\26config.startup_config\nsetup\fstartup\frequire\0" },
    loaded = true,
  ...
  ["telescope-symbols.nvim"] = {
    loaded = true,
    path = "/home/ra/.local/share/nvim/site/pack/packer/start/telescope-symbols.nvim",
